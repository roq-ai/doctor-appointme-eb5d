...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Doctor Appointment System v3`}</title>

        <meta
          name="description"
          content="v3 is your seamless portal to healthcare. Schedule, manage and track your medical appointments with ease and convenience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Doctor Appointment System v3`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`v3 is your seamless portal to healthcare. Schedule, manage and track your medical appointments with ease and convenience.`}
            </Text>
            <Box
